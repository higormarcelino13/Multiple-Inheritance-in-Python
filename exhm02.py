...
class Pessoa:
    ...
    def __str__(self):
        return f'{self.nome} - {self.endereco} - {self.fone} - {self.cpf}'
...
class Aluno(Pessoa):
    ...
    def __str__(self):
        return f'{super().__str__()} - {self.incluir_disciplina}'
...
class Professor(Funcionario):
    ...
    def __str__(self):
        return f'{super().__str__()} - {self.titulacao} - {self.disciplina}'
